...
MaceGuard 6.1.7 keeps runtime plugin integrations out of its compile surface whenever their public Maven artifacts are not stable long-term dependencies.
