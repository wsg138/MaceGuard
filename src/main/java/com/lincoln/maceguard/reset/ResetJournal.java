...
public record ResetJournal(String operationId, String worldUuid, String regionId, String geometryHash,
    ...
    public boolean requiresAdministratorReview() {
        return status == Status.PREPARED || status == Status.RESTORING || status == Status.FAILED;
    }

    public boolean interrupted() { return requiresAdministratorReview(); }
}
